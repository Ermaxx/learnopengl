/*
  edited by dvolk to work with OpenGL 2.1 (GLSL 1.2)
 */
...
static const char* ImGui_ImplGlfwGL2_GetClipboardText()
{
    return glfwGetClipboardString(g_Window);
}

static void ImGui_ImplGlfwGL2_SetClipboardText(const char* text)
{
...
bool ImGui_ImplGlfwGL2_CreateFontsTexture()
{
    // Build texture atlas
    ImGuiIO& io = ImGui::GetIO();
...
#undef OFFSETOF
    ...
    ImGui_ImplGlfwGL2_CreateFontsTexture();
